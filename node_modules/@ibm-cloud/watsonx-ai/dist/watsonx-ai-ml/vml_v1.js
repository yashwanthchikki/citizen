...
class WatsonxAiMlVml_v1 extends ibm_cloud_sdk_core_1.BaseService {
    ...
    static newInstance(options) {
        ...
        if (typeof options.caCert === 'string') {
            const certFile = fs_1.default.readFileSync(options.caCert);
            httpsAgentAuth = new https_1.Agent({
                ca: certFile,
            });
            options.httpsAgent = httpsAgentAuth;
        }
        else if ((_b = (_a = options.caCert) === null || _a === void 0 ? void 0 : _a.auth) === null || _b === void 0 ? void 0 : _b.path) {
            const certFile = fs_1.default.readFileSync(options.caCert.auth.path);
            httpsAgentAuth = new https_1.Agent({
                ca: certFile,
            });
        }
    ...
    constructor(options) {
        ...
        if ((_b = (_a = options.caCert) === null || _a === void 0 ? void 0 : _a.service) === null || _b === void 0 ? void 0 : _b.path) {
            const certFile = fs_1.default.readFileSync(options.caCert.service.path);
            this.httpsAgentMap.service = new https_1.Agent({
                ca: certFile,
            });
        }
        if ((_d = (_c = options.caCert) === null || _c === void 0 ? void 0 : _c.dataplatform) === null || _d === void 0 ? void 0 : _d.path) {
            const certFile = fs_1.default.readFileSync(options.caCert.dataplatform.path);
